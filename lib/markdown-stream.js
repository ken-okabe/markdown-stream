...
module.exports = {
  activate: function(state)
  {
    ...
    atom.workspaceView.command('markdown-stream:on', function()
    {
      console.log('markdown-stream:onoff command');
      onF();
      //  IO.mdPane.val = !IO.mdPane.val;
    });

    atom.workspaceView.command('markdown-stream:off', function()
    {
      console.log('markdown-stream:onoff command');
      offF();
      //  IO.mdPane.val = !IO.mdPane.val;
    ...
    Object.observe(IO.mdPane, function(changes)
    {
      console.log('IO.mdPane.val changed');
    ...
    //-------
    var editor1 = atom.workspace.open(uri,
    {
      split: 'right',
      searchAllPanes: true,
      changeFocus: false
                ...
                c
                  .pipe(d(
                  {
                    ...
                    bind: function(val, f) // must keep this format
                    {
                      ...
                      {
                        console.log('IO.txt.val changed');
